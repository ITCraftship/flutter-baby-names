...
void main() {
  group('NameVote should', () {
    test('be equal when id, name and votes are equeal', () {
      const record1 = NameVote(id: '123', name: 'Test', votes: 4);
      const record2 = NameVote(id: '123', name: 'Test', votes: 4);
      expect(record1 == record2, isTrue);
    });

    test('be equal when any of id, name and votes are not equeal', () {
      const record1 = NameVote(id: '123', name: 'Test', votes: 4);
      const record2 = NameVote(id: '123', name: 'Test 1', votes: 4);
      const record3 = NameVote(id: '1234', name: 'Test', votes: 4);
      const record4 = NameVote(id: '123', name: 'Test', votes: 9);
